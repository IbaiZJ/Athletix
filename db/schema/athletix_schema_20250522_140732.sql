...
CREATE TABLE `chat` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKdjfy9lgrb6jbectnjohekgjfs` (`user1_id`),
  KEY `FKo429l2mmipkdeucixqrkkoo6x` (`user2_id`),
  CONSTRAINT `FKdjfy9lgrb6jbectnjohekgjfs` FOREIGN KEY (`user1_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FKo429l2mmipkdeucixqrkkoo6x` FOREIGN KEY (`user2_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-22 14:07:32
