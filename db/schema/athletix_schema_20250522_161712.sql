...
CREATE TABLE `friends_chats` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKoto1bhtg3w1rsvi21x69i2sxo` (`message_id`),
  CONSTRAINT `FKoto1bhtg3w1rsvi21x69i2sxo` FOREIGN KEY (`message_id`) REFERENCES `messages` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-22 16:17:12
