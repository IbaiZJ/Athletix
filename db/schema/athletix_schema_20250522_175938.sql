...
CREATE TABLE `messages` (
  ...
  KEY `FK113ac5ypiremmu627rbtl369t` (`group_chat_id`),
  CONSTRAINT `FK113ac5ypiremmu627rbtl369t` FOREIGN KEY (`group_chat_id`) REFERENCES `groups_chats` (`id`),
...
CREATE TABLE `users_friends` (
  ...
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKbcw7puhe3t892xut2puyxddtt` (`friend_chat_id`),
  KEY `FKetin2ga6w0oln69xfef2wwjqw` (`friend_id`),
  KEY `FKry5pun2eg852sbl2l50p236bo` (`user_id`),
  CONSTRAINT `FKbcw7puhe3t892xut2puyxddtt` FOREIGN KEY (`friend_chat_id`) REFERENCES `friends_chats` (`id`),
...
CREATE TABLE `users_groups` (
  ...
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK8fny7jwrxiphvc47807ito3lw` (`group_chat_id`),
  KEY `FKg6fu0mfuj9eqfd9aro1nc40nn` (`user_id`),
  CONSTRAINT `FK8fny7jwrxiphvc47807ito3lw` FOREIGN KEY (`group_chat_id`) REFERENCES `groups_chats` (`id`),
...
-- Dump completed on 2025-05-22 17:59:38
